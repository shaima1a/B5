...
(explanatory variables) plus a final offset (also known as the intercept).
...
![](../assets/linear_data.svg){width=100%}
...
![](../assets/linear_fit.svg){width=100%}
...
Choose line that minimizes error (distance between predictions data points).

::: columns
::: column

![](../assets/linear_fit_red.svg){width=100%}
...
Measure Error (squared distance):
...
![](../assets/lin_reg_3D.svg){width=100%}
...
![](../assets/categorical.svg){width=100%}
...
The output of the model is interpreted as: probability of `y` being 1 (red) for a given `x`.

::: columns
::: column

![](../assets/logistic_color.svg){width=100%}
...
Two classes (binary): `y=orange` or `y=blue`

::: columns
::: column

Middle shows decision boundary lines shifting color.

![](../assets/logistic_2D.svg)

:::
::: column

Height corresponds to probabiliy of `y = orange`.

![](../assets/logistic_3D.svg)
...
![](../assets/multinomial.svg){width=100%}
